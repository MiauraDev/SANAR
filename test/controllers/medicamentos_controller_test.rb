...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference("Medicamento.count") do
      post medicamentos_url, params: { medicamento: { dosis: @medicamento.dosis, duracion: @medicamento.duracion, efectos_secundarios: @medicamento.efectos_secundarios, frecuencia: @medicamento.frecuencia, nombre: @medicamento.nombre, proveedor: @medicamento.proveedor, tratamiento_id: @medicamento.tratamiento_id } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { dosis: @medicamento.dosis, duracion: @medicamento.duracion, efectos_secundarios: @medicamento.efectos_secundarios, frecuencia: @medicamento.frecuencia, nombre: @medicamento.nombre, proveedor: @medicamento.proveedor, tratamiento_id: @medicamento.tratamiento_id } }
