class MedicosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @medico.save
        format.html { redirect_to @medico, notice: "" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to medicos_path, status: :see_other, notice: "" }
  ...
  private
    ...
    def medico_params
      params.require(:medico).permit(:nombre, :apellido, :especialidad, :telefono, :email, :licencia, :años_experiencia)
    end
end
