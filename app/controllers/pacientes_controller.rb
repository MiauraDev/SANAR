class PacientesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @paciente.save
        format.html { redirect_to @paciente, notice: "" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pacientes_path, status: :see_other, notice: "" }
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:nombre, :apellido, :fecha_nacimiento, :genero, :telefono, :direccion, :tipo_sangre)
    end
end
